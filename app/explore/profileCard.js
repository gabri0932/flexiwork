    ...
    const card = `
        <div class="profile-card">
            <div class="profile-header">
                <img class="profile-header" src="${profile.images.cover ?? 'CandA/stars-2643089_640.jpg'}" alt="">
            </div>
            <div class="price-tag">${profile.price.currency.toUpperCase()}$${profile.price.amount}/hr</div>
            <div class="profile-body">
                    <img class="profile-img" src="${profile.images.avatar ?? 'CandA/ba2510941031447abd07257f369caf95.jpg'} " alt="">
